              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					?>
                      <tr>
                        <td><a href="crm_edit_cus.php?c=<?=$ord['p_number']?>"><?=$ord['p_number']?></a></td> 
                        <td><?=$ord['p_name']?></td>
						<td><?=$ord['s_number']?></td>
                        <td><?=$ord['p_nuit']?></td>
                        <td><?=$ord['price']?></td>
						...
						<td><a href="crm_edit_cus.php?c=<?=$ord['p_number']?>">新增</a><br><a href="process/process_crm_del_c.php?c=<?=$ord['s_number']?>">刪除</a></td>
                      </tr>
					<?php
						}
					?>
